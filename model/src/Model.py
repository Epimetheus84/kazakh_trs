...
class Model:
	...
	def setupRNN(self):
		...
		numHidden = 256
		cells = [tf.rnn.LSTMCell(num_units=numHidden, state_is_tuple=True) for _ in range(2)] # 2 layers

		# stack basic cells
		stacked = tf.rnn.MultiRNNCell(cells, state_is_tuple=True)
	...
	def setupCTC(self):
		...
		if self.decoderType == DecoderType.BestPath:
			...
			corpus = open('./model/data/corpus.txt').read()
