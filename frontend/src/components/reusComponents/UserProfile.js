...
const Profile = (props) => {
    ...
    return (
        <WrapPaper profile={true}>
            ...
            <Details profile={true} >Создана: {new Date(showCreated * 1000).getDate()}.{new Date(showCreated * 1000).getMonth()}.{new Date(showCreated * 1000).getFullYear()} {new Date(showCreated * 1000).getHours()}:{new Date(showCreated).getMinutes()}</Details>
            <Details profile={true} >Послед. изменение: {new Date(showCreated * 1000).getDate()}.{new Date(showCreated * 1000).getMonth()}.{new Date(showCreated * 1000).getFullYear()} {new Date(showCreated * 1000).getHours()}:{new Date(showCreated).getMinutes()}</Details>
        </WrapPaper>
    )
}
